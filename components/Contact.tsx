...
const Contact = () => {
  return (
    <div className='flex flex-col justify-center items-center gap-[40px] p-5'>
     ...
     <a
      ...
      <div className='flex flex-col gap-6 w-full sm:w-[80vw] md:w-[60vw] lg:w-[40vw] max-w-4xl justify-center items-center mx-10 mb-10 mt-5 p-10 rounded-[35px] border-[2px] border-blue-400 shadow-[0_0_15px_5px_rgba(0,0,255,0.7)]'>
        ...
        <div className='flex flex-col gap-2 w-full justify-center items-center'><Input type='submit' value='Send Message' className='w-full md:w-[10vw] cursor-pointer p-2 mt-0' /></div>
